...
final lastMoviesMoviesProvider = StateNotifierProvider<MoviesNotifier, List<Movie>>((ref) {
...
//* best rated movies
final bestRatedMoviesProvider = StateNotifierProvider<MoviesNotifier, List<Movie>>((ref) {
